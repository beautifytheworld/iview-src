...
export default {
  ...
  data () {
    return {
      ...
      payChanelTypes: [{ label: '闪付3', value: '闪付3' }, { label: '闪付5', value: '闪付5' }, { label: '闪付6', value: '闪付6' }, { label: '新闪付2', value: '新闪付2' }, { label: '新支付', value: '新支付' }],
      statusObj: {
        '0': '等待支付',
        '1': '支付完成',
        '2': '支付失败'
  ...
  methods: {
    ...
    async queryList () {
      try {
        ...
        const res = this.handleResult(result, ['OrderId', 'UserId', 'Amount', 'PayType', 'PayChanel', 'CreateTime', 'MoneyAfter', 'FinishTime', 'Status'])
