...
<template>
  <div>
    <div class="home-main">
      ...
      <div class="home-report">
        <div class="home-report-top">
          ...
          <!-- <Button class="publish-btn" @click="showAddModal">发布公告</Button> -->
          <a class="more-btn" @click="queryMore">更多公告&nbsp;</a>
        </div>
        <Table :loading="moreLoading" :columns="columns" disabled-hover :data="tableDatas" :show-header="false" height="400" stripe></Table>

      </div>
    </div>
    <Modal v-model="modal5" width="720">
    ...
    <Modal v-model="showAdd" title="添加公告信息" width="600">
      <Form :model="addRow" ref="formValidate" :rules="ruleValidate" label-position="right" :label-width="120">
        ...
        <FormItem label="内容" prop="MsgContent">
          <Input v-model="addRow.MsgContent" style="width:360px" type="textarea" :autosize="{minRows: 8,maxRows: 10}" placeholder="Enter something..."></Input>
        </FormItem>
        ...
        <FormItem label="排序" prop="OrderNum">
          <Input v-model="addRow.OrderNum" style="width:360px"></Input>
        </FormItem>
      </Form>
    ...
    <Modal v-model="showEdit" title="编辑公告信息" width="600">
      <Form :model="editRow" ref="editFormValidate" label-position="right" :label-width="120">
        <FormItem label="标题" prop="MsgTitle">
          <Input v-model="editRow.MsgTitle" :rules="{ required: true, message: '请输入标题', trigger: 'blur' }" style="width:360px"></Input>
        </FormItem>
        <FormItem label="内容" prop="MsgContent">
          <Input v-model="editRow.MsgContent" style="width:360px" type="textarea" :autosize="{minRows: 8,maxRows: 10}" placeholder="Enter something..."></Input>
        </FormItem>
        <FormItem label="开始时间" prop="StartTime">
        ...
        <FormItem label="排序" prop="OrderNum">
          <Input v-model="editRow.OrderNum" style="width:360px"></Input>
        </FormItem>
      </Form>
      <div slot="footer" style="color:#f60;text-align:center">
        <Button type="default" @click="cancel">取消</Button>
