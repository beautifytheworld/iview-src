...
export default {
  ...
  getWithdrawalList (params) {
    return http({
      url: '/api/all-withdrawal-list',
      method: 'get',
      params
    })
  },
  // 获取客服出款统计列表
  getWithdrawalStatList (params) {
    return http({
      url: '/api/withdrawal-stat-list',
      method: 'get',
      params
    })
  },
  ...
  getWJStatic (params) {
    return http({
      url: '/api/agent/wj_static',
      method: 'get',
      params
    })
  },
  //   玩家游戏轨迹
  getPlayerFootmark (params) {
    return http({
      url: '/api/agent/player_footmark',
      method: 'get',
      params
    })
  },
  //   新手分析
  getNewPlayerList (params) {
    return http({
      url: '/api/agent/new_player_list',
      method: 'get',
      params
    })
  },
  getApiRecordList (params) {
    return http({
      url: '/api/agent/api_record',
      method: 'get',
      params
    })
  },
  getApiAccount (params) {
    return http({
      url: '/api/agent/api_account',
      method: 'get',
      params
    })
  },
  insertApiAccount (data) {
    return http({
      url: '/api/agent/api_account',
      method: 'post',
      data
