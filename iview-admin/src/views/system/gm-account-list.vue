  ...
  <div>
    ...
    <Modal v-model="showEdit" title="编辑管理账号" width="480">
      <Form :model="editRow" ref="editFormValidate" label-position="right" :label-width="140">
        ...
        <FormItem label="ip白名单" prop="IPPermission">
          <Input v-model="editRow.IPPermission" style="width:260px"  placeholder="输入ip白名单"></Input>
          <br>多个ip用分号;分隔，清空表示不限IP
        </FormItem>
      </Form>
      <div slot="footer" style="color:#f60;text-align:center">
        <Button type="default" @click="cancel">取消</Button>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      statusObj: { '1': '启用', '0': '禁用' },
      roleLevelTypes: [{ label: '管理员', value: '0' }, { label: '运营客服', value: '1' }, { label: '运营', value: '10' }, { label: '全民运营', value: '20' }, { label: '普通客服', value: '100' }, { label: '审核客服', value: '1000' }, { label: '客服主管', value: '999' }],
      loading: false,
      query: {},
      datasTime: [],
      page: 1,
  ...
  methods: {
    ...
    showEditModal (index) {
      ...
      this.editRow = {
        ...
        IPPermission: this.tableDatas[index].IPPermission
      }
    },
    toEdit (name) {
      this.$refs[name].validate((valid) => {
