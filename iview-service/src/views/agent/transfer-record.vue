    ...
    <Modal v-model="showModal" title="转账记录信息" width="520">
      <Form :model="showRow" label-position="right" :label-width="140">
        <FormItem label="订单ID：" prop="AccountName">
          <Input v-model="showRow.a0" style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="订单类型：" prop="NickName">
          <Input :value="'充值'" style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="代理名称：" prop="AcPwd">
          <Input v-model="showRow.a2"  style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="用户ID：" prop="Pwd_confirm">
          <Input v-model="showRow.a6"  style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="充值金额：" prop="Pwd_confirm">
          <Input :value="-(showRow.a3)"  style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="大写金额：" prop="Pwd_confirm">
          <Input :value="moneyUppercase(-showRow.a3)"   style="width:240px" readonly></Input>
        </FormItem>
        <FormItem label="充值时间：" prop="Pwd_confirm">
          <Input v-model="showRow.a8"  style="width:240px" readonly></Input>
        </FormItem>
  ...
  methods: {
    ...
    async queryList () {
      try {
        ...
        const res = this.handleResult(result, ['a0', 'a1', 'a2', 'a3', 'a4', 'a5', 'a6', 'a7', 'a8'])
    ...
    showShowModal (index) {
      if (this.tableDatas[index].a0 !== '累计转出:') {
        this.showModal = true
