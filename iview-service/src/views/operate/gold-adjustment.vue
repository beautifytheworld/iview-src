<template>
  <div>
    ...
    <Page :total="total" :page-size-opts="[10,20,30]"
          :current="page"
    ...
    <Modal v-model="showAdd"
      ...
      <Form :model="addRow"
        ...
        <FormItem label="调整数量"
                  prop="BankMoney">
          <InputNumber  v-model="addRow.BankMoney"
                 style="width:200px" placeholder="正数代表增加,负数代表扣除"></InputNumber>
        </FormItem>
        <FormItem label="调整原因"
                  prop="reason">
