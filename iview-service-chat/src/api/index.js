...
export default {
  ...
  serviceClientBind (data) {
    return http({
      url: '/api/service_bind',
      method: 'post',
      data
    })
  },
  ...
  // 获取未处理的玩家信息
  getMessageNotReplay (params) {
    return http({
      url: '/api/msg_not_replay',
      method: 'get',
      params
    })
  },
  ...
  // 客服某段时间内最后一次打卡记录
  getLastOnePunchCards (params) {
    return http({
      url: '/api/last_one_punch_card',
      method: 'get',
      params
    })
  },
