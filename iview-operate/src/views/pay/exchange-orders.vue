<template>
 ...
 <GameLog :show="showGame" @cancel="showGame=false" @page-change="gpageChange" @page-size-change="gpageSizeChange" :loading="gameLoading" :columns="gColumns"  :tableDatas="gameTableDatas" :current="gPage" :total="gTotal"
