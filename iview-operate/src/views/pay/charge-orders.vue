<template>
 ...
 <GameLog :show="showGame" @cancel="showGame=false"
  @page-change="gpageChange" @page-size-change="gpageSizeChange" :loading="gameLoading" :columns="gColumns"  :tableDatas="gameTableDatas" :current="gPage" :total="gTotal"

  @gj-page-change="gjpageChange" @gj-page-size-change="gjpageSizeChange" :gjLoading="gjLoading" :gjColumns="gjColumns"  :gjTableDatas="gjTableDatas" :gjPage="gjPage" :gjTotal="gjTotal"></GameLog>
