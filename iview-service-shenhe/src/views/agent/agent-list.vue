      ...
      <Form :model="addRow" ref="formValidate" :rules="ruleValidate" label-position="right" :label-width="120">
        ...
        <FormItem label="提成比例" prop="RebatePercent">
          <div style="display:flex;">
            ...
            <div style="color:#f00;padding-left:5px;">可设定范围：0-35,设置后比例只可上调不可下调！</div>
  ...
  methods: {
    ...
    async queryList () {
      try {
        ...
        const res = this.handleResult(result, ['AgencyID', 'AccountName', 'NickName', 'RebatePercent', 'CurMoney', 'TotalMoney', 'UserId', 'ParentID', 'AcPwd', 'AliPay', 'ParentTree', 'WXID', 'WX', 'Mobile', 'AgentLv', 'Status', 'LastIP', 'LastTime', 'CreateTime'])
