<template>
  <div>
    <Form  ref="formDynamic" :model="query" label-position="right" :label-width="70" inline>
      ...
      <FormItem label="ID:" prop="UserID" class="">
      ...
      <FormItem label="手机:" :label-width="50" class="">
      ...
      <FormItem label="设备:"  :label-width="50" class="">
     ...
     <FormItem label="注册平台:" class="">
      ...
      <FormItem label="注册时间:" class="">
         <Button :type="btTypes[3]" @click="changeDate(-1)" size="small">昨天</Button>
      ...
      <FormItem label="姓名:" :label-width="50" class="">
...
export default {
  ...
  data () {
    return {
      ...
      query: { RegisterDevice: '', RoomName: 0, UserID: '' },
      datasTime: [],
      page: 1,
      per_page: 20,
      total: 0,
